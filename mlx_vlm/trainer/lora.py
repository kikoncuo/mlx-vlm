...
class LoRaLayer(nn.Module):
    def __init__(
        ...
        # Standard LoRA scaling: alpha / rank (consistent with PEFT / the
        # original LoRA paper).  Previously this used raw alpha, which made
        # the effective perturbation rank-times larger than intended.
